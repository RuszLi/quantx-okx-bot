...
- **策略 ID：** `funding_0e0b12a6`
- **策略名称：** `funding_z_2.0_rr_3.0`
- **所属阶段：** `rejected`
...
```json
{
  "funding_window": 960,
  "r_to_r": 3.0,
  "regime_quantile_high": 0.8,
  "regime_quantile_low": 0.5,
  "rv_window": 6,
...
- **必备输出文件：** `docs/strategies/funding_0e0b12a6.md`
