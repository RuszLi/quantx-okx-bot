...
> §18.4 单 edge 证据闸门报告  |  生成时间: 2026-06-26T04:49:12.903699+00:00
...
见 `sensitivity_grid.csv` (共 60 笔交易,3x3x3=27 cells)
ROBUSTNESS 评级: `FAIL`

## 8. 文件清单

- `per_strategy/pre_funding_unwind/trades.csv`
- `per_strategy/pre_funding_unwind/summary.json`
- `per_strategy/pre_funding_unwind/sensitivity_grid.csv`
- `per_strategy/pre_funding_unwind/group_by_*.csv`
- `per_strategy/pre_funding_unwind/point_in_time_evidence.json` (event-driven 策略)
