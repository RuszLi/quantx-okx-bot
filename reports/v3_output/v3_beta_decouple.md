...
> §18.4 单 edge 证据闸门报告  |  生成时间: 2026-06-25T22:48:15.281482+00:00
...
- **win_rate**: 0.9162
- **EV(R)**: 0.3442
- **profit_factor**: 51.8097
- **max_consec_losses**: 2
- **max_drawdown_pct**: 98.14%
...
- **price_pnl_R_total**: 215.6457
- **fee_slippage_R_total**: 55.8695
...
见 `sensitivity_grid.csv` (共 525 笔交易,3x3x3=27 cells)
ROBUSTNESS 评级: `HIGH`

## 8. 文件清单

- `per_strategy/beta_decouple/trades.csv`
- `per_strategy/beta_decouple/summary.json`
- `per_strategy/beta_decouple/sensitivity_grid.csv`
- `per_strategy/beta_decouple/group_by_*.csv`
- `per_strategy/beta_decouple/point_in_time_evidence.json` (event-driven 策略)
